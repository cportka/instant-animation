...
| --- | --- |
| **Above the Fog** | *an overhead view of tons of billowing flowing fog under a gusting wind, wisps dissolving and changing into each other, over a lazy winding river and a riverside town in reversed colour — and every few minutes one cloud pixelates into an angel, then a grim reaper, then a giant happy face* |
